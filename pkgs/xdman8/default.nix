...
stdenv.mkDerivation rec {
  ...
  installPhase = ''
    ...
    # Create wrapper and set environment variable to ignore icon error
    makeWrapper $out/opt/xdman/xdm-app $out/bin/xdman8 \
      ...
      --set GDK_PIXBUF_MODULE_FILE ""  # Disable the loading of image modules (this might prevent the error)
